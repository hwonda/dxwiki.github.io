      ...
      >
        <div className="flex flex-col">
          <div className='flex justify-between items-center'>
            <span className="text-lg text-primary font-semibold group-hover:text-main">{term.title?.ko}</span>
      ...
      <div className="flex flex-col">
        <div className='flex justify-between items-center'>
          <div className="flex items-center">
            <span className="text-lg sm:text-2xl text-primary font-semibold group-hover:text-main">{term.title?.ko}</span>
        ...
        <span className="hidden sm:block text-primary truncate group-hover:text-main">{term.title?.en}</span>
